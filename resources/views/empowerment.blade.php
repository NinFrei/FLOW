    ...
    <div class="container-fluid mt-3">
                <div class="row">
                        <div class="col-md-8 p-3">
                            <!--<div class="card">-->
                                <h1 class="mb-5">„Programmierte Ungerechtigkeit“: Laut einer neuen Doku werden Frauen tagtäglich von der Technik diskriminiert!</h1>
                                ...
                                <p class="text-break">
                                    ...
                                    <ins>Job</ins> suchen, einen Kredit abschließen oder uns einfach auf einer sozialen Plattform austauschen wollen: Algorithmen
                                    verstärken Vorurteile und wirken diskriminierend auf <b>Frauen</b> und Minderheiten.
                                <p>
                               
                                <p class="mt-3">Über diese digitale Ausgrenzung wird in der neuen Doku <b>„Programmierte Ungerechtigkeit“ gesprochen.</b> Es
                                    </p>
                                    
                                <h2 class="mt-5">Programmierte Ungerechtigkeit: Warum ist Technik sexistisch?</h2>
                                
                                
                                <p class="mt-5">Schuld an der <b>digitalen Diskriminierung</b> von Frauen sind Algorithmen oder besser: diejenigen,
                                    die Algorithmen
                                    programmieren. Ein Algorithmus ist eine Art Gebrauchsanweisung, die einem Computer sagt, was er machen soll, um eine
                                    bestimmte Aufgabe zu bewältigen. Diese Regeln werden hauptsächlich von Männern geschrieben.
                                    Nur
                                    16 Prozent der Programmierer:innen in diesem Bereich weiblich. Weil aber diese Regeln nie unsere diverse und
                                    komplexe
                                    Welt abbilden können, werden Algorithmen so konzipiert, dass sie sich weiterbilden können. Leider orientieren sich allerdings die meisten Datensätze
                                    an
                                    Männern – weil diese nun mal als Standard gelten.
                            
                                </p>
                                
                                <p class="mt-5">Sehr oft wird Technik entwickelt, die dann diejenigen, die sozial eh schon schwach sind, noch mehr
                                ...
                                <p class="mt-5">Matthias Spielkram erzählt von einem Experiment, das er mit seiner Organisation AlgorithmWatch
                                    ...
                                    gelernt, welcher Beruf eher zu Männern und welcher eher zu Frauen passt.</p>
                                   
                                <p class="mt-5">Auch Google hält an traditionellen Geschlechterrollen fest, wie ein anderes Beispiel: Die
                                ...
                                <h2 class="mt-5">Besonders schlimm: Mehrfachdiskriminierung in der digitalen Welt</h2>
                               
                                <p class="mb-3">Die Beispiele zeigen, dass die Hälfte der Weltbevölkerung aufgrund ihres Geschlechts von Algorithmen
                                    benachteiligt
                                    werden kann. Noch gravierender wird es laut der Expert:innen, wenn eine Frau zusätzlich zum Beispiel aufgrund ihrer
                                    Herkunft, Hautfarbe, Klasse oder sexuellen Orientierung diskriminiert wird. Die Unternehmerin Jen
                                ...
                                <p class="mb-3">Auch die Mutter und Influencerin Tanja Marfo hat Diskriminierung auf Instagram erlebt – in ihrem
                                    Fall war es
                                    ...
                                    <br>
                                <p class="mb-3">Die Expert:innen sind sich also einig: Algorithmen folgen sexistischen und
                                    ...
                                    Gerechtigkeit sorgen …
                                        ...
                                        <div class="col-md-4 p-3">
                                            <div class="container text-center" style="margin-top:50%;">
                                                ...
                                                <img src= "./img/female .jpg" class="responsive" alt="female" width="450" height="600"> 
                                                <p class="unter-text">Foto: ZDF</p>
                                                <p class="unter-text">Sind die Algorithmen in unserem digitalen Leben diskriminierend und sexistisch? </p>
                                            </div>
                                            
                                            <div class="container text-center" style="margin-top:40%;">
                                            <img src= "./img/pomellato-women-iwd-video-2022.jpg" class="responsive" alt="female" width="450" height="250"> 
                                            
                                            </div>
                                            <div class="container text-center" style="margin-top:40%;">
                                            <img src= "./img/gettyimages-13407230711.jpg" class="responsive" alt="female" width="450" height="250"> 
