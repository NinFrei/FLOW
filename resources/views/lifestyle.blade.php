...
@section('lifestyle')
<div class=container>
    <h1 class="mt-4">Interior: 5 Deko-Fehler, die die Wohnung kleiner wirken lassen</h1>
    <div class="mt-5"><p class="card-text mb-0 pb-0 text-center">Klein, aber oho! Auch in einer Wohnung mit wenig Platz lässt es sich hervorragend leben.</p> <p class="text-center pt-0 mt-0">Damit die
